...
flags.DEFINE_string('logdir', 'archived_results/cnn_multinist/logdir', 'logs directory')
...
flags.DEFINE_string('results', 'archived_results/cnn_multinist/results', 'path for saving results')
...
flags.DEFINE_integer('image_size', 36, 'width and height of the image')
flags.DEFINE_integer('image_size_flatten', 1296, 'width*height of the image')
